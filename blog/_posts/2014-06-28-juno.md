...
The Light Table project is a really interesting step in this direction, and I think it makes an excellent base for a Julia environment. Despite having it’s roots in Emacs-like editors, it’s not just an Emacs clone in a different Lisp, and has plenty of interesting ideas of it’s own — from simple things like familiar default shortcuts to novel features like inline results. On top of that, it’s easy to modify and extend, meaning that we can be imaginative in choosing features to support without the burden of building everything from scratch.
