...
![duffing Poincaré section](/images/blog/2017-09-01-gsoc-ode/duffing_poincare_0.svg)
...
![driven pendulum Poincaré section](/images/blog/2017-09-01-gsoc-ode/driven_poincare_0.svg)

## Boundary Value Problem

The MIRK solver in [`BoundaryValueDiffEq`](https://github.com/JuliaDiffEq/BoundaryValueDiffEq.jl) doesn't have adaptivity and dense output yet, but with all the things that I have learned from IVPs, I can finish it rather quickly. Here is an example of using the `BoundaryValueDiffEq` package. In this example, we will solve the problem
...
![bvp](/images/blog/2017-09-01-gsoc-ode/bvp.svg)
